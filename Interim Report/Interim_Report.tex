...
The issue that caching poses is that specific \texttt{cudaMalloc()} calls
...
Thus far, tensors have been referred to but not yet explained in detail.
\myworries{HIGHLIGHT the refcount field in Storage.h http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/#storage}\\\\
\myworries{Should i put this section before caching?}
