...
\end{lstlisting}
Next, the \texttt{forward} method in Listing \ref{listing:nn.module_example} is examined.


Aside from this, a \texttt{parameter} has all the same functionality as a normal tensor.
