...
\end{tabular}}
\caption{Neural Collaborative Filtering memory breakdowns for varying batch sizes. All values rounded to nearest MB.}
...
\label{conclusion}
% TODO: future work: more investigation into intermediate grads, and work on layer-by-layer activation breakdown
